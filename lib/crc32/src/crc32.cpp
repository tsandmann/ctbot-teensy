...
static PROGMEM const uint32_t crc32_table[] = { 0x00000000, 0x1db71064, 0x3b6e20c8, 0x26d930ac, 0x76dc4190, 0x6b6b51f4, 0x4db26158, 0x5005713c, 0xedb88320,
...
void CRC32::update(const uint8_t& data) {
    ...
    uint8_t tbl_idx = _state ^ (data >> (0 * 4));
