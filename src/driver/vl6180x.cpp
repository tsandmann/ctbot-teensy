...
namespace ctbot {
VL6180X::VL6180X(const uint8_t i2c_bus, const uint32_t i2c_freq, const uint8_t i2c_addr)
    : i2c_ { i2c_bus, i2c_freq, CtBotConfig::I2C0_PIN_SDA, CtBotConfig::I2C0_PIN_SCL }, i2c_addr_ { i2c_addr }, ptp_offset_ {}, scaling_ {} {}
