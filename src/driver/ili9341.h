...
class ILI9341 : public TFT_SPI {
protected:
    static constexpr uint32_t TFT_WIDTH { 240 };
    static constexpr uint32_t TFT_HEIGHT { 320 };
    ...
    struct Commands {
        ...
        static constexpr uint8_t FRAME_CTRL_1 { 0xb1 };
        static constexpr uint8_t FRAME_CTRL_2 { 0xb2 };
        static constexpr uint8_t FRAME_CTRL_3 { 0xb3 };

        static constexpr uint8_t DISPLAY_FUNC_CTRL { 0xb6 };
        ...
        static constexpr uint8_t VCOM_CTRL_2 { 0xc7 };
